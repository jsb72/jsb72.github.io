...
/** @type {string} */
const CACHE_VERSION = '1777116102|10542581062';
/** @type {string} */
const CACHE_PREFIX = 'A False story-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libropesim.web.template_release.wasm32.nothreads.wasm"];
